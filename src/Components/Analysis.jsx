...
const Analysis = (props) => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (score <= 69) {
        ...
        setAnalysisScore(
          " Amazing round 👏. You scored in the 96th percentile."
        );
      } else if (score <= 77) {
        ...
        setAnalysisScore(
          "Mediocre round 😕. You scored in the 25th percentile."
        );
      } else if (score <= 93) {
        setAnalysisScore(
          "Mediocre round 😕. You scored in the 19th percentile."
        );
      } else if (score <= 95) {
        setAnalysisScore(
          "Mediocre round 😕. You scored in the 13th percentile."
        );
      } else if (score <= 95) {
        setAnalysisScore(
          "Mediocre round 😕. You scored in the 13th percentile."
      ...
      if (putts / holes < 1.5) {
        ...
        //36-38
        setAnalysisPutting(
          "Your putting was decent, nothing more nothing less."
        );
      ...
      if (upAndDowns / possibleUpAndDowns < 0.08) {
        ...
        setAnalysisChipping(
          "Your chipping is bad. Get out there and practice. "
        );
  ...
  return (
    <div className="analysis-container">
      ...
      <div className="loading-animation">LOADING PLACEHOLDER</div>
